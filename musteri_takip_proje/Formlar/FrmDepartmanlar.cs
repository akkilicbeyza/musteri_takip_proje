...
namespace musteri_takip_proje.Formlar
{
    public partial class FrmDepartmanlar : Form
    {
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            XtraMessageBox.Show("Departman Silme İşlemi Başarılı Bir Şekilde Gerçekleştirildi.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            Listele();
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            deger.Ad = TxtAd.Text;
            db.SaveChanges();
            XtraMessageBox.Show("Departman Güncelleme İşlemi Başarılı Bir Şekilde Gerçekleştirildi.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            Listele();
        }
    }
}
